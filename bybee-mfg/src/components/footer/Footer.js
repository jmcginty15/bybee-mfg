    ...
    return (
        <div className="Footer">
            ...
            <div className="Footer-tag">
                <small>
                    <svg className="Footer-svg" onClick={() => followExternalLink("http://jasonmcginty.net/")} version="1.0" xmlns="http://www.w3.org/2000/svg" width="40px" height="20px" fill="#dfa440" viewBox="0 0 11117.000000 6458.000000" preserveAspectRatio="xMidYMid meet">
