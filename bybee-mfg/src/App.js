      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/services/cnc-milling">
            <DetailPage title={cncMilling.title} text={cncMilling.text} />
          </Route>
          <Route exact path="/services/cnc-turning">
            <DetailPage title={cncTurning.title} text={cncTurning.text} />
          </Route>
          <Route exact path="/services/fabrication">
            <DetailPage title={fabrication.title} text={fabrication.text} />
          </Route>
